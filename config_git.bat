...
git config --global user.name "VictorTeitei"
git config --global user.email "victor75008@gmail.com"

:: Adiciona o repositório remoto (só executa se já não estiver adicionado)
git remote get-url origin >nul 2>&1
if errorlevel 1 (
    git remote add origin "https://github.com/VictorTeitei/RepositorioNuvem.git"
)
